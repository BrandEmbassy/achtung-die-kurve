          ...
          <div className="mx-auto max-w-md">
            ...
            <div className="divide-y divide-gray-300/50">
              ...
              {player?.name
                ...
                : <form onSubmit={handleRegisterPlayer} className="divide-y divide-gray-300/50">
                  <div className="py-8">
                    <label htmlFor="name" className="block text-sm font-medium text-gray-700">
                      Player name
                    </label>
                    <input name="name" type={'text'} className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                    ...
                    {Object.keys(Colors).map((color) => (
                      <div
                        ...
                        className={"h-12 p-4 rounded-lg flex items-center justify-center hover:border-4 border-indigo-600 {color}} shadow-sm hover:cursor-pointer" + (player?.color === color ? " border-4" : undefined)}
                      >
                      </div>
                    ))}
                    </div>
